...
if(isset($_POST['order_btn'])){
    ...
    if(mysqli_num_rows($cart_query) > 0){
       ...
       $detail_query = mysqli_query($conn, "INSERT INTO `order`(user_id, name, number, email, method, address, city, country, state, total_products, total_price) VALUES('$user_id','$name','$number','$email','$method','$address','$city','$country','$state','$total_product','$price_total')") or die('query failed');
    }else{
        $message[] = 'Não há produtos adicionados no carrinho! (Clique para ocultar)';
    };
    ...
    <div id="box">
        ...
        <div id="cadastro">
            <form action="comprar.php" method="post">
                ...
                ?>
                <p id="text"><?= $fetch_cart['name']; ?> (<?= $fetch_cart['quantity']; ?>)</p>
                <?php
                    }
                }else{
                    echo "<p id='text'>Seu carrinho está vazio!</p>";
                }
                ?>
                <p id="text1">Total:</p>
                ...
                ?>
                <p id="valor">R$<?=$preco;?></p></br></br>

                <label for="name"><b>Nome:</b></label><br><br>
                ...
                <label for="address"><b>Endereço:</b></label><br><br>
                <input type="text" id="address" name="address" required placeholder="Insira seu endereço."><br><br>

                <label for="city"><b>Cidade:</b></label><br><br>
                <input type="text" id="city" name="city" required placeholder="Insira sua cidade."><br><br>

                <label for="country"><b>Pais:</b></label><br><br>
                <input type="text" id="country" name="country" required placeholder="Insira seu pais."><br><br>

                <label for="state"><b>Estado:</b></label><br><br>
                <input type="text" id="state" name="state" required placeholder="Insira seu estado."><br><br>

                <label for="method"><b>Forma de Pagamento:</b></label><br><br>
                <select id="method" name="method">
                    <option value="pagar na entrega" selected>Pagar na entrega</option>
                ...
                <label for="number"><b>Numero de Telefone:</b></label><br><br>
                <input type="number" id="number" name="number" required placeholder="Insira seu telefone."><br><br>

                <div id='botão'>
                    <input type="submit" name="order_btn" value="Concluir Pagamento" id="confirmar"/>
                </div>
