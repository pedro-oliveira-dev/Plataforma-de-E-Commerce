...
if (isset($_POST['update_cart'])) {
    ...
    $message[] = 'Quantidade do carrinho atualizada com sucesso!';
}
...
<body>
    <div id="page-container">
        <div id="content-wrap">
            ...
            <ul id="drop">
                <li class="dropdown">
                    <a href="javascript:void(0)" class="menu"> <svg width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="compras">
                ...
                ?>
                        <div id="secoes">
                            ...
                            <div class="a">
                                <img id="images" src="<?php echo $fetch_cart['image']; ?>">
                                <a id="descricao"><br><?php echo $fetch_cart['name']; ?></a><br><br>
                                <a id="promo">À vista no PIX com até 15% OFF</a><br><br>
                                <?php //formatando o número de preço para o formato br
                                $preco = $fetch_cart['price'];
                                ...
                                <form action="" method="post">
                                    <div id="quanti">
                                        ...
                                        <input id="quantidade" type="number" name="cart_quantity" value="<?php echo $fetch_cart['quantity']; ?>">
                                        <label id="quantidade1" name="quantidade">Quantidade</label>
                                    </div>
                                    <input type="submit" name="update_cart" value="Atualizar" class="option-btn">
                                    <div id="precoquantidade">
                                        <p>Total: R$ <?php $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']);
                                                        $sub_total_format = $sub_total;
                                                        $sub_total_format = number_format($sub_total_format, 2, ',', '.');
                                                        echo $sub_total_format; ?></p>
                                    </div>
                                </form>
                        ...
                        <a href="carrinho.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('Remover este item do carrinho?');"><svg width="64px" height="64px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill="#000000" id="fechar">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                ...
                <?php
                    ...
                    //echo '<div id="secoes1"><div class="page-bottom1">Nenhum item adicionado</div></div>';
                }
                ?>
                <div id="secoes1">
                    <div class="a">
                        <div class="page-bottom">
                            <p>Valor final : R$ <?php $grand_total_format = $grand_total;
                                    $grand_total_format = number_format($grand_total_format, 2, ',', '.');
                                    echo $grand_total_format; ?></p>
                            <a href="carrinho.php?delete_all" onclick="return confirm('Deletar tudo do carrinho?');" id="delete" class="delete-btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>">Deletar tudo</a>
                        </div>

                        <div class="cart-btn">
                            <a href="comprar.php" id="btn-disabled" class="btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>">Finalize o pagamento</a>
                        </div>
