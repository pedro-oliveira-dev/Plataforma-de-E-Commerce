...
<div id="header">
    ...
    <div id="conteudo-principal">
        ...
        Somos um grupo de 5 estudantes entusiasmados do curso de Desenvolvimento de Sistemas que está embarcando em um projeto de TCC empolgante. Nosso objetivo é criar um site inovador e funcional, que demonstre nossa proficiência e conhecimentos adquiridos ao longo do curso.
        Cada membro do grupo desempenha um papel fundamental no desenvolvimento do projeto
</p><br/><br/>

        <p id="informativo">       
        Como um grupo, colaboramos de forma eficaz, compartilhamos conhecimentos e tomamos decisões conjuntas para criar um site excepcional que atenda aos requisitos do TCC e 
        supere as expectativas. Estamos empolgados em mostrar nosso trabalho e apresentar os resultados finais deste projeto de TCC.
        </p>

        <br />

        <h1 id="titulo">Horários de atendimento:</h1>

        <p id="informativo2">
        Segunda a Sexta 8h ás 12h e das 13h ás 18h <br/><br/>
        Email: Vinsmoke.Informartica@gmail.com.br<br/><br/>
        Nossos telefones: +55 (19) 99715-8723<br/>
        </p>
      </div>
    <br/><br/>
