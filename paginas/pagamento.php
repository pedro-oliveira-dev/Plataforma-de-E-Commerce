...
<div id="end">
    ...
    <div id="conteudo-principal">
        ...
        <br>
        <h1 id="titulo"> MEIOS DE PAGAMENTO</h1>
        <br />

        <p id="informativo2">Cartões de Credito</p><p id="promocao"> Em ate 12x sem Juros</p><br>

        <p id="informativo3">Você pode pagar a qualquer momento com seu código, sem custo adicional e o crédito é na hora.</p><br>

        <img id="images" src="../images/cartao1.png">
        <img id="images" src="../images/cartao2.png">
        <img id="images" src="../images/cartao3.png"><br><br>
        ...
        <img id="images" src="../images/cartao4.png">
        <img id="images" src="../images/cartao5.png">
        ...
        <img id="images" src="../images/boleto.png">
        ...
        <img id="images" src="../images/pix.png">
