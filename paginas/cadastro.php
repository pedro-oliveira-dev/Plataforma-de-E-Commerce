...
?>
    ...
    <div id="box">
        ...
        <h1 id="titulo" >Cadastro</h>
        
            <div id="cadastro">
                <form action="" method="post">
                    <label for="name"><b>Nome:</b></label><br><br>
                    <input type="text" id="fname" name="name" required placeholder="Insira seu nome."><br><br>
                    ...
                    <label for="senha"><b>Confirme sua senha:</b></label><br><br>
                    <input type="password" id="senha" name="cpassword" required placeholder="Confirme sua senha."><br><br>
                    <p>Caso já tenha uma conta, faça o login <a href="login.php">aqui</a></p>
                    <div id='botão'>
                        <input type="submit" name="submit" value="Cadastrar" id="confirmar"/>
                    </div>
                </form>
            </div>
